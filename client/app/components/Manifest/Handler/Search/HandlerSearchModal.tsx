...
export function HandlerSearchModal() {
  ...
  if (siteType === 'designatedFacility') {
    ...
    description =
      'Search by EPA ID. Without RCRAInfo credentials, try local demo ID MOCKTSDFS001.';
  } else if (siteType === 'transporter') {
    title = 'Add Transporter';
    description =
      'Search by EPA ID. Without RCRAInfo credentials, try local demo IDs MOCKTRANS001 or MOCKTRANS002.';
  } else {
    title = 'Add Generator';
    description =
