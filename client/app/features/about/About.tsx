    ...
    <div className="tw-w-full tw-p-5">
      ...
      <div className="tw-content tw-flex tw-flex-wrap">
        <div className="tw-md:w-5/12 tw-lg:w-1/2 tw-w-full">
          <p>
            Haztrak helps hazardous waste handlers manage electronic manifests and interface with{' '}
            <a href="https://rcrainfo.epa.gov">RCRAInfo</a> e-Manifest. Complete common shipping
            workflows without logging into RCRAInfo through a web browser.
          </p>
        </div>
