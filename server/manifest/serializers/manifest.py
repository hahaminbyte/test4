...
class ManifestSerializer(RemoveEmptyFieldsMixin, serializers.ModelSerializer):
    ...
    def validate(self, data):
        """Assign a local draft MTN when creating a NotAssigned manifest without one."""
        mtn = data.get("mtn")
        status = data.get("status")
        if status == "NotAssigned" and not mtn:
            data["mtn"] = draft_mtn()
    ...
    def to_internal_value(self, data):
        ...
        instance["import_flag"] = bool(data.get("import", False))
        return instance
