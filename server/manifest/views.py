...
from manifest.services.dashboard import get_dashboard_stats
...
class DashboardStatsView(APIView):
    """Return dashboard chart aggregations for the authenticated user."""

    def get(self, request: Request) -> Response:
        """Get dashboard stats."""
        data = get_dashboard_stats(username=request.user.username)
