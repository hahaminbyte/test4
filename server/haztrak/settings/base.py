...
CACHES = {
    "default": {
        ...
        # Default to localhost so the project can run without Docker.
        # docker-compose overrides this via HT_CACHE_URL in configs/.env.dev.
        "LOCATION": os.getenv(CACHE_URL, "redis://localhost:6379"),
    },
}
REDIS_URL = os.getenv(CACHE_URL, "redis://localhost:6379")  # used for Health Checks
